-- I used MySQL to run these queries. Sheets from the pre-cleaned Excel file "Ramen Full List 2022.03.09" were
...
-- will only focus on the "overall best", all-inclusive lists: the Top Pack, Top Boxed, Top Cup, and Top Tray lists, and the
-- Reader's Choice Top 10.
...
-- number of reviews per country to get a better look at the data.
...
-- results a bit, but look at Malaysia: even with a sizeable 230 noodles in the database, almost 1 in 5 made it on
-- a Top 10 list. Impressive! In fact, if we look at only noodles that rank number 1 across all lists (barring
...
-- This has been data analysis with SQL. I hope you found th data as interesting as I did!
