...
Much better! Finally, let's do some graphing. Let's graph the average consumption per capita per year, grouping by region. We will use ggplotly to add labels.
